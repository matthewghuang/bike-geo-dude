...
import { b as _defineProperty, _ as _extends, h as hoistNonReactStatics_cjs, a as _objectWithoutPropertiesLoose, r as reactIs, c as _inheritsLoose } from './common/hoist-non-react-statics.cjs-4d70d6b8.js';
...
var addPlaceholder = function addPlaceholder(droppable, draggable, draggables) {
  var frame = droppable.frame;
  !!isHomeOf(draggable, droppable) ? invariant$1(false) : void 0;
  !!droppable.subject.withPlaceholder ? invariant$1(false) : void 0;
...
var createDimensionMarshal = (function (registry, callbacks) {
  ...
  var updateDroppableIsEnabled = function updateDroppableIsEnabled(id, isEnabled) {
    !registry.droppable.exists(id) ? invariant$1(false) : void 0;
...
function useDroppablePublisher(args) {
  ...
  var onClosestScroll = useCallback(function () {
    ...
    !(dragging && closest) ? invariant$1(false) : void 0;
  ...
  var scroll = useCallback(function (change) {
    ...
    !dragging ? invariant$1(false) : void 0;
    var closest = getClosestScrollableFromDrag(dragging);
    !closest ? invariant$1(false) : void 0;
...
export { DragDropContext, PublicDraggable as Draggable, ConnectedDroppable as Droppable };
